...
class prediction:
    ...
    def __init__(self,path):
        self.file_object = open("Phishing/Prediction_Logs/Prediction_Log.txt", 'a+')
    ...
    def predictionFromModel(self):
        ...
        try:
            ...
            path="Phishing/Prediction_Output_File/Predictions.csv"
            result.to_csv("Phishing/Prediction_Output_File/Predictions.csv",header=True) #appends result to prediction file
